      ...
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          ...
          <Link href="/integracoes" style={{textDecoration:'none'}}>
            <div style={{
              ...styles.navItem,
              ...(router.pathname === '/integracoes' ? styles.navItemActive : {})
            }}>
      ...
      <div style={styles.main}>
        <header style={styles.topbar}>
          ...
          <div style={styles.topbarRight}>
            ...
            <Link href="/campanhas">
              <button style={styles.btnPrimary}>+ Nova Campanha</button>
            </Link>
          </div>
        </header>
...
const styles = {
  app: {
    ...
    background: `
      radial-gradient(ellipse 70% 55% at 5% 10%, rgba(37,211,102,0.13) 0%, transparent 55%),
      radial-gradient(ellipse 60% 50% at 95% 90%, rgba(80,100,255,0.11) 0%, transparent 55%),
      #090910
    `,
    position: 'relative',
  },
